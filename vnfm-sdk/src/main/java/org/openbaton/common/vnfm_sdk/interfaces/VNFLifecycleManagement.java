...
public interface VNFLifecycleManagement {
	...
	VirtualNetworkFunctionRecord instantiate(VirtualNetworkFunctionRecord virtualNetworkFunctionRecord, Object scripts, VimInstance vimInstance) throws Exception;
	/**
