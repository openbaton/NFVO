...
public class VirtualDeploymentUnit implements Serializable {
   ...
   * that two instance of the same VDU will co-exists with continuous data synchronization.
   * ActivePassive: Implies that two instance of the same VDU will co-exists without any data
   * synchronization.
   */
