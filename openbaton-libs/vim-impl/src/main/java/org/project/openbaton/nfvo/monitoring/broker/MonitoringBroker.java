package org.project.openbaton.nfvo.monitoring.broker;
...
@Service
@Scope
public class MonitoringBroker implements org.project.openbaton.nfvo.vim_interfaces.monitoring.MonitoringBroker {
