...
public class VNFPackageMetadata implements Serializable {
            ...
            for (String supportedOsId : OS_ID_LIST){
                if(supportedOsId.equals("Ubuntu")){
                    for(String supportedOsVersion: UBUNTU_VERSION_LIST)
                        if(supportedOsVersion.equals(osVersion))
                            result=true;
                }
    ...
    public void setOsId(String osId) {
        if(osId!=null) {
            ...
            throw new IllegalArgumentException("'osId' is not correct. Choose one of the following: "+ Arrays.toString(OS_ID_LIST));
        }
    }
    ...
    public void setOsArchitecture(String osArchitecture) {
        if(osArchitecture!=null ){
            ...
            throw new IllegalArgumentException("'osArchitecture' is not correct. Choose one of the following: "+Arrays.toString(OS_ARCH_LIST));
        }
    }
    ...
    public void addRepoConfigurationInfo(AdditionalRepoInfo additionalRepoInfo){
        if(additionalRepoInfo ==null)
            throw new NullPointerException("AdditionalRepoInfo is null");
    ...
    public String toString() {
        return "VNFPackageMetadata{" +
                ...
                ", type='" + type + '\'' +
                ", md5sum='" + md5sum + '\'' +
                ", iconRepoId='" + iconRepoId + '\'' +
                ", nfvoVersion='" + nfvoVersion + '\'' +
                ", downloadCounter=" + downloadCounter +
                ", osId=" + osId +
                ", osVersion=" + osVersion +
                ", osArchitecture=" + osArchitecture +
                ", additionalRepoInfoList=" + additionalRepoInfoList +
                '}';
    }
