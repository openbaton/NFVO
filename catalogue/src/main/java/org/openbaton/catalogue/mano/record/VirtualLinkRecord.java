...
public class VirtualLinkRecord extends AbstractVirtualLink {
  ...
  /**
   * Flag to report status of the VL (e.g. 0=Link down, 1= normal operation, 2= degraded operation,
   * 3= Offline through management action)
   */
  @Enumerated(EnumType.STRING)
  private LinkStatus status;
  /**
   * System that has registered to received notifications of status changes TODO consider a
  ...
  /**
   * Record of detailed operational events (e.g. link up/down, Operator logins, Alarms sent) TODO
   * consider a stream to a file
   */
  @ElementCollection(fetch = FetchType.EAGER)
