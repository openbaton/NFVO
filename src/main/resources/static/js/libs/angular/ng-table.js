(function(angular, factory) {
    ...
    angular.module('ngTable').run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('ng-table/filters/text.html', '<div  class="input-group"> <div style="box-shadow: none !important;" class="input-group-addon"><i class="fa fa-search"></i> </div><input style="font-weight: normal !important;" type="text" name="{{name}}" ng-disabled="$filterRow.disabled" ng-model="params.filter()[name]" class="input-filter form-control" placeholder="Search"/></div> ');
